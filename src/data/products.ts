...
import type { DsCategory, ProductFoundations } from "@/data/foundations/types";
import { WEB_FOUNDATIONS, WEB_COMPONENT_CATEGORIES } from "@/data/products/web";
import { CORE_FOUNDATIONS, CORE_COMPONENT_CATEGORIES } from "@/data/products/core";
import { SCRAPY_FOUNDATIONS } from "@/data/products/scrapy";
import { EXTRACT_SUMMIT_FOUNDATIONS } from "@/data/products/extract-summit";
