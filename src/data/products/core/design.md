<!--
  ...
  - 2026-04-29 — arkadiusz — added: First draft. Mirrors the Web canonical spec, scoped to Core platform UIs.
-->
---
version: alpha
name: Core
description: Zyte Core design system for the platform, dashboards and internal tooling.
colors:
  brand-600: "#3F4FED"
