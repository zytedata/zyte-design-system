<!--
  ...
  - 2026-04-27 — maja      — changed: Expanded Do's and Don'ts with sponsor-section guidance.
  - 2026-04-20 — arkadiusz — added:   Hand-authored canonical spec for the agentic markdown surface.
-->
---
version: alpha
name: Extract Summit
description: Wolff Olins-inspired Brutalist Power Infrastructure visual system for the Extract Summit website.
colors:
  primary: "#FF3D00"
  ...
  border: "#1C1C1C"
  card-border: "#222222"
  ghost-on-black: "#0D0D0D"
  ghost-on-grey: "#1E1E1E"
  panel: "#111111"
  footer-text: "#333333"
  eyebrow: "#444444"
  error: "#FF8A8A"
...
components:
  ...
  stat-slab:
    backgroundColor: "{colors.primary}"
    textColor: "{colors.on-primary}"
    typography: "{typography.statement-mid}"
    rounded: "{rounded.none}"
    padding: "80px 40px"
  cursor:
    backgroundColor: "{colors.primary}"
    textColor: "{colors.primary}"
    rounded: "{rounded.none}"
    width: "{spacing.cursor-sm}"
    height: "{spacing.cursor-sm}"
  divider:
